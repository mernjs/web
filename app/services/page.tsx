...
const services = [
  { icon: Globe,        title: 'Web Design & Development', subtitle: 'Beautiful, High-Performance Websites',   desc: "From landing pages to web applications, we build solutions that help move your business ahead. Increase engagement and conversions through the high-performance, visually stunning websites we create for you. ", features: ['Custom Design & Branding','React & Next.js Apps','WordPress Development','Landing Pages','Progressive Web Apps','Performance Optimization'], techs: ['React.js','Next.js','Laravel','WordPress','TypeScript','Tailwind CSS'], color: '#4f6ef7' },
  { icon: Smartphone,   title: 'App Development',           subtitle: 'Mobile Apps That Users Love',           desc: 'We develop mobile applications (native and cross-platform) with a focus on a seamless and user-friendly experience. As your reliable mobile app development company in Noida, we develop applications using the latest frameworks for both iOS and Android.',           features: ['iOS & Android Dev','Cross-Platform Flutter','UI/UX Design','API Integration','Push Notifications','App Store Optimization'],                                              techs: ['Flutter','React Native','Swift','Kotlin','Dart','Firebase'],           color: '#7c3aed' },
  { icon: Database,     title: 'CRM Development',           subtitle: 'Custom CRM Built for Your Business',    desc: "With scalable, custom-built CRM systems designed around your workflow, we optimize your processes, improve visibility, and strengthen customer relationships. Our dedicated approach makes us the best CRM development company Noida.",           features: ['Lead Management','Sales Pipeline','Custom Dashboards','Email/SMS Integration','Reporting & Analytics','Role-Based Access'],                                              techs: ['Node.js','React','PostgreSQL','Redis','REST APIs','WebSockets'],        color: '#06d6a0' },
  { icon: Megaphone,    title: 'Digital Marketing',         subtitle: 'Data-Driven Growth Strategies',         desc: 'Our digital marketing expertise includes SEO services in Noida, as well as PPC, social media, and content marketing. By relying on strategies that are performance-oriented, we seek to increase visibility and leads, thereby maximizing your ROI. ',  features: ['SEO','PPC Advertising','Social Media','Content Marketing','Email Marketing','Analytics & Reporting'],                                                                  techs: ['Google Ads','Meta Ads','SEMrush','GA4','Hotjar','Mailchimp'],           color: '#f97316' },
  { icon: ShoppingCart, title: 'E-Commerce Solutions',      subtitle: 'Online Stores Built to Sell',          desc: 'We also serve companies looking for eCommerce website development Noida by developing secure, scalable e-commerce platforms that deliver seamless shopping experiences. We help you scale your online business with confidence.', features: ['Custom E-Commerce','WooCommerce/Shopify','Payment Gateways','Inventory Management','Order Tracking','Multi-currency'],                                                  techs: ['WooCommerce','Shopify','Stripe','Razorpay','PHP','React'],              color: '#ec4899' },
  ...
  { icon: Settings,     title: 'API Development',           subtitle: 'Connect Everything, Seamlessly',       desc: 'Sauranium Technologies enables enhanced connectivity/integration, as well as faster innovation & development. We emphasize the design, development, testing, and maintenance of APIs.',                       features: ['RESTful API Design','GraphQL APIs','Third-Party Integrations','Webhook Implementation','API Documentation','Auth & Security'],                                         techs: ['Node.js','Express','GraphQL','JWT','OAuth','Swagger'],                  color: '#8b5cf6' },
];
